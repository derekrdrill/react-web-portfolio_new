...
describe('Job Applications Page tests', () => {
  ...
  it('renders JobApplicationSelectLabelText styled component correctly', () => {
    ...
    expect(jobApplicationSelectLabelText.props().className).toEqual('sc-fhzFiK eluMYB');
    expect(jobApplicationSelectLabelTextDark.props().className).toEqual('sc-fhzFiK fulJdI');
  });
  ...
  it('renders JobApplicationsSelectRow styled component correctly', () => {
    ...
    expect(jobApplicationsSelectRow.props().className).toEqual('sc-eBMEME aKqSI');
    expect(jobApplicationsSelectRowDark.props().className).toEqual('sc-eBMEME ieupSU');
  });
});
