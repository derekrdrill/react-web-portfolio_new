      ...
      <JobAppHeaderContainer container darkMode={darkMode}>
        ...
        <JobAppInstructionsContainer container justifyContent='center'>
          <Typography component='span' textAlign={{ xs: 'center' }} variant='h6'>
            Please carefully read and answer all questions below. You will not be able to submit
            this application until all questions are answered.
          </Typography>
...
export const JobAppHeaderContainer = styled(Grid)(({ darkMode }) => ({
  backgroundColor: darkMode ? 'darkgrey' : 'gainsboro',
  borderRadius: '5px 5px 0 0',
  padding: 10,
}));

export const JobAppSubmitButtonContainer = styled(Grid)({
  padding: 10,
});
